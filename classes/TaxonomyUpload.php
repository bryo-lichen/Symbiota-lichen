	...
	public function transferUpload(){
		...
		do{
			...
			$sql = 'INSERT INTO taxa(kingdomName, SciName, RankId, UnitInd1, UnitName1, UnitInd2, UnitName2, UnitInd3, UnitName3, cultivarEpithet, tradeName, Author, Source, sourceIdentifier, nomenclaturalStatus, Notes) '.
				'SELECT DISTINCT "'.$this->kingdomName.'", SciName, RankId, UnitInd1, IFNULL(NULLIF(TRIM(UnitName1),""), TRIM(SciName)), UnitInd2, UnitName2, UnitInd3, UnitName3, cultivarEpithet, tradeName, IFNULL(Author,""), Source, sourceIdentifier, nomenclaturalStatus, Notes '.
				'FROM uploadtaxa '.
